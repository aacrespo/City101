"""
LOCK 05 — GRADIENT DISPATCHER (v3 — Site-placed)
...
- Coordinate system: local origin with offset from LV95
  Offset: E-2538500, N-1152500 (stored as metadata dot on terrain)
...
=============
    ...
    Local origin of lock = ground level at Level 0 (bottom/south),
    center of south facade, THEN shifted by SITE_ORIGIN.
    ...
    LEVELS (floor Z elevations, relative to SITE_ORIGIN.z):
...
# SITE PLACEMENT — v3
# ---------------------------------------------------------------------------
# Local coordinates (offset from LV95 by E-2538500, N-1152500)
# CHUV campus edge: terrain elevation ~451m
...
def create_terrain():
    ...
    terrain_pts = [
        (-14, -2, -3),  (14, -2, -3),  (14, 36, -3),  (-14, 36, -3),
        (-14, -2,  0),  (14, -2,  0),  (14, 36, 5.1), (-14, 36, 5.1),
    ]
